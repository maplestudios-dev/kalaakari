/**
 * KALAAKAARI · default site copy (bundled for SSR-safe first render)
 * Mirrors apps/api/src/lib/defaultCopy.js.
 *
 * The API is the source of truth in production — this file exists so the site
 * still renders something sensible if the API is slow or unreachable.
 */
export const defaultCopy = {
  ...
  pillars: {
    eyebrow: 'Pillars', eyebrowDeva: 'हमारे स्तंभ',
    title: 'Three forces.\nOne craft.',
  ...
  work: {
    eyebrow: 'Selected Work', eyebrowDeva: 'चुनिंदा कार्य',
    title: "Sneak peek into\nwhat we're up to.",
    viewAllCta: { label: 'View All Work →', to: '/work' }
  },

  services: {
    eyebrow: 'What we do', eyebrowDeva: 'हमारी सेवाएँ',
  ...
  // ─── Per-page copy (independent of homepage sections above) ───────
  pages: {
    ...
    contact: {
      ...
      eyebrowDeva: 'शुरू करें',
      title1: 'Tell us what',
      title2: 'you want to make.',
